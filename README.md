...
Version 0.5.9 is an M1 development checkpoint plus the first complete M2
...
install -m 0644 dist/owl-docs_0.5.9_amd64.deb /tmp/owl-docs_0.5.9_amd64.deb
sudo apt install /tmp/owl-docs_0.5.9_amd64.deb
owl-docs
```
