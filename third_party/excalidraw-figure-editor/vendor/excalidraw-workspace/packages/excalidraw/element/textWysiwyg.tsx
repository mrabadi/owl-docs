...
export const textWysiwyg = ({
  ...
  const updateWysiwygStyle = () => {
    ...
    if (updatedTextElement && isTextElement(updatedTextElement)) {
      ...
      // `font` is shorthand, but Chromium can retain an old individual style
      // property on an existing textarea.  Keep the live editor aligned with
      // the model explicitly when emphasis changes during text editing.
